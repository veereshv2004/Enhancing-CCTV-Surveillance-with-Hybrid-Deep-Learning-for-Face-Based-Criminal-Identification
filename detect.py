...
label_0 = Label(root, text="Enhancing CCTV Surveillance with Hybrid Deep Learning for Face Based Criminal Identification ",width=85,font=("bold", 20),anchor=CENTER,bg="grey",fg="white")
...
for img in images_name:
   data = fr.face_encodings(img)[0]
   encodings.append(data)

print(str(len(images_name))+" =="+str(len(encodings)))
...
for name in images:
   ...
   if "." not in name:
      ...
      print((os.path.splitext(name)[0]).split('.')[1])
   '''
