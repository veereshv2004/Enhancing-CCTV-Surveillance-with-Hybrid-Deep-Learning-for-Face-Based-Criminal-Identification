...
class App:
	def __init__(self,video_source=0):
		self.appname="Enhancing CCTV Surveillance with Hybrid Deep Learning for Face Based Criminal Identification"
		self.window=Tk()
	...
	def showPercentageMatch(self,face_distance,face_match_threshold=0.95):
